...
public class CaptureView2 extends Canvas implements Observer {
	...
	Button throwBallButton;
	 ...
	 PokeCaptureAnimation captureAnimation;
	
	
	public CaptureView2(Capture capture, double width, double height,BorderPane window) {
		
		this.setWidth(width);
		this.setHeight(height);
		this.window=window;
		this.capture = capture;
		captureAnimation=new PokeCaptureAnimation(this,"file:images/battle/battle-background.png",capture.currentPoke.getStandByPath(),capture.currentPoke.getRunAwayPath(),capture.currentPoke.getCapturePath());
